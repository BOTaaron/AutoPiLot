...
class BarometricPressureSensor(object):
    ...
    Be aware that heat from the Raspberry Pi will affect temperature sensor readings.
    """
    ...
    def get_temperature_and_pressure_and_altitude(self):
        """Returns pressure in hPa as double. Returns temperature as celsius and altitude as metres. """
